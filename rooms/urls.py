...
from .views import (
    ...
    default_image  # Import de la vue default_image pour afficher une image par défaut
)
...
urlpatterns = [
    ...
    path('default_image',
         default_image, name='default_image')  # Définit l'URL pour l'image par défaut avec la vue default_image
]
