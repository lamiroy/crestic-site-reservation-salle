...
def export_to_excel(request):
    ...
    data = BookedRoom.objects.select_related('user', 'room_category').all().values(
        'id', 'date', 'startTime', 'endTime', 'groups', 'status', 'motif', 'peopleAmount', 'user__username', 'room_category__libRoom'  # Ajoutez les champs nécessaires ici
    )
