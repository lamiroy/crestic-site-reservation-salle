document.addEventListener('DOMContentLoaded', function() {
        ...
        eventClick: function(info) {
            ...
            if (eventData.holiday === "false") {
                ...
                eventTitle.innerHTML = `
                    ${start} - ${end}&ensp;❘&ensp;
                    <span class="modal-detail-title">${eventData.nom}</span>`; // Titre de l'événement
                ...
                if (eventData.holiday === "false") {
                    eventDetailsButtons.innerHTML = `
                        <a id="ancreEdit" class="btn btn-primary button-style" href="/equipmentbooking/${eventData.id}/edit/">Modifier</a>
                        <a id="ancreDelete" class="btn btn-danger card-link button-style button-red" href="/equipmentbooking/${eventData.id}/delete/">Annuler</a>
                    `;
                }
            } else {
    ...
    calendarEquipment.render(); // Afficher le calendrier
